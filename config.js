const ownerNumber = ["556492606313@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '556492606313' 
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO ᴊᴇғғ ʙᴏᴛ COM 363 COMANDOS, BATERIA: ${battery}`
}
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=556492606313:+55 64 9260-6313\n' 
+ 'END:VCARD'
